...
لهذا الإحباط صنعت **Panel 010**. هو لا يضع قالباً فوق الصورة؛ بل يحدد أولاً ما لا يجوز فقدانه، ثم يترجمه إلى **يحوّل الصورة إلى ظل خشن أسود بوسيط جاف على ورق أبيض، كصفحة من كتاب أطفال**.
